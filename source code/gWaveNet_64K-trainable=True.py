...
kernel_64 = np.repeat(kx, 64, axis=3)

#Define custom kernels
def custom_layer_64(shape, dtype=None):
  print(shape)
  kernel_in = kernel_64
...
model.add(layers.Conv2D(64, (7, 7), activation='relu', kernel_initializer=custom_layer_64, traibale=True, padding='same', input_shape=(200, 200, 1)))
...
h = model.fit(train_generator, epochs = 2000, steps_per_epoch = 17, validation_data=validation_generator, callbacks=[checkpoint])
