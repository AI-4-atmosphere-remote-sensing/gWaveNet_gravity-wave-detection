...
# fit model
checkpoint = keras.callbacks.ModelCheckpoint('saved_mdoel{epoch:08d}.h5', period=500)
h = model.fit(train_generator, epochs = 3000, validation_data=validation_generator, callbacks=[checkpoint])
model.save_weights('l204apr23.h5')
