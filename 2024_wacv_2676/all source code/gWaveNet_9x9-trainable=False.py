...
model.add(layers.Conv2D(1, (9, 9), activation='relu', kernel_initializer=custom_layer, trainable=False, padding='same', input_shape=(200, 200, 1)))
model.add(layers.MaxPool2D(pool_size=(2,2), padding='same', strides=(2,2)))

model.add(layers.Conv2D(512, (9, 9), activation='relu', padding='same', kernel_regularizer = regularizers.l2(1e-4)))
