...
model.add(layers.Conv2D(1, (3, 3), activation='relu', kernel_initializer=custom_layer, l2(1e-4), trainable=False, padding='same', input_shape=(200, 200, 1)))
